...
public class AwsS3ResultStoreTest {
    ...
    private static AwsS3ResultStore resultStore;
    ...
    public static void initialize() {
        ...
        resultStore = (AwsS3ResultStore)TemplateServiceRegistry.getConfiguration().getResultStore();
        TESTBUCKET = resultStore.getBucketName();
        ...
        try {
            ...
            final String msg = "Error creating test data: " + e.getMessage();
            log.warn(msg);
        }
    }
    ...
    public static void teardown()	{
        ...
        try {
            ...
            if (!listObjects.isEmpty()) {
                ...
                log.info("No test files found to delete.");
            }
        } catch (final S3Exception e) {
