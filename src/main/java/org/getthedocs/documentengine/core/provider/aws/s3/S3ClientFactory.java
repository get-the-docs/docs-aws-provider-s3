...
/**
 * Factory class for creating AWS S3Client instances.
 * <p>
 * This class provides methods to create S3Client instances with different configurations,
 * including the default region and specific bucket regions.
 * </p>
 */
@Slf4j
