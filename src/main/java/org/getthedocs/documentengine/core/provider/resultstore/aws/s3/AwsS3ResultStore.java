package org.getthedocs.documentengine.core.provider.resultstore.aws.s3;
...
import org.getthedocs.documentengine.core.provider.aws.s3.AbstractAwsS3Repository;
import org.getthedocs.documentengine.core.provider.aws.s3.S3ClientFactory;
import org.getthedocs.documentengine.core.provider.aws.s3.S3Repository;
import org.getthedocs.documentengine.core.provider.resultstore.ResultStore;
import org.getthedocs.documentengine.core.service.exception.*;
...
public class AwsS3ResultStore extends AbstractAwsS3Repository implements ResultStore, S3Repository {
    ...
    public boolean registerTransaction(final String transactionId) {
        ...
        final String pathToFile = this.prefix + "/"
                + transactionDir + (!transactionDir.isEmpty() ? "/" : "") + RESULTSTORE_PROVIDER_FLAGFILE;
        ...
        try {
            ...
            if (!transactionCheckResponse.contents().isEmpty()) {
    ...
    public StoredResultDocument save(final ResultDocument resultDocument) {
        ...
        final String pathToFile = this.prefix + "/" + transactionDir + (!transactionDir.isEmpty() ? "/" : "")
